...
The boxplot below compares the length of trips (less than 50 miles) for every trip purpose and income group. Each row of plots shows an income group, and each column is a trip purpose. Note that the HBW (home-based work) column shows interesting trends because of the few number of employed workers in the wheelchair-dependent population.
